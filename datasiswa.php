 ...
 //if ($_SESSION['level']=="") {
   //header("location:datasiswa.php?pesan=gagal");
 //}
//?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
  ...
  <center>
    <a class="btn btn-success" href="export_excel.php">EXPORT KE EXCEL</a>
    <a class="btn btn-success" href="export_pdf.php">EXPORT KE PDF</a>
    <a class="btn btn-success" href="upload.php">IMPORT DARI EXCEL</a>
</center>
<br>
...
<div class="row">
            ...
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i class=""></i> No</th>
                    <th><i class=""></i> Foto</th>
                    <th><i class=""></i> NISN</th>
   ...
   { 
    echo"
   	<tr>
        <td>".$no++. "</td>
        <td><img src ='gambar/".$d['foto']."' width='100' height='100' ?></td>
        <td>".$d['nisn']."</td>
        <td>".$d['nama']."</td>
        <td>".$d['alamat']."</td>
        <td>".$d['tingkat'] .$d['kelas']."</td>
          <td>
          <a href='editsiswa.php?id=$d[id];'>EDIT</a><br>
          <a href='deletesiswa.php?id=$d[id];'>HAPUS</a>
        </td>
      </tr>";
