...
?>
		...
		<form method="POST" action="updatesiswa.php" enctype="multipart/form-data">
			<table>
         ...
         <div> NISN<br>
              <input type="text"  name="nisn" value="<?php echo $d['nisn'];?>">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="alamat" value="<?php echo $d['alamat'];?>"></td></tr>
                ...
                <div class="form-group"> 
                  ...
                  <div class="form-group">
                    <label>Foto</label><br>
                    <input type="checkbox" name="ubah_foto" value="true">Ceklis jika ingin megubah foto!<br>
